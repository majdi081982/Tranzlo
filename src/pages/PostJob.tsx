...
import { ArrowRight, FileText, Globe, DollarSign, CheckCircle2 } from 'lucide-react';
              ...
              <>
                ...
                <CardContent className="space-y-6 pt-6">
                  <div className="space-y-2">
                    ...
                    <Input id="title" placeholder="e.g., Mobile App Localization for Spanish Market" className="h-12 rounded-xl" />
                  </div>
                  <div className="space-y-2">
              ...
              <>
                ...
                <CardContent className="space-y-6 pt-6">
                  <div className="space-y-2">
                    ...
                    <LanguageSelector placeholder="Translate from..." />
                  </div>
                  <div className="space-y-2">
                    <Label>Target Language(s)</Label>
                    <LanguageSelector placeholder="Translate to..." />
                    <p className="text-xs text-slate-500">You can add more languages after posting.</p>
                  </div>
                ...
                <CardContent className="space-y-6 pt-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="budget" type="number" placeholder="500" className="h-12 rounded-xl" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="deadline">Deadline</Label>
                      <Input id="deadline" type="date" className="h-12 rounded-xl" />
                    </div>
                  </div>
            ...
            {step === 4 && (
              <CardContent className="p-12 text-center">
                ...
                <div className="flex flex-col gap-3">
                  <Button className="h-12 bg-indigo-600 rounded-xl" onClick={() => window.location.href = '/jobs'}>
                    View Your Project
                  </Button>
